<?php
    ...
    class Ville {
        ...
        public function removeSite(Site $site): self {
            ...
            if ($this->sites->removeElement($site) && $site->getVille() === $this) {
                $site->setVille(null);
            }
            return $this;
        }
        ...
        public function removeSortiesOrganisees(Sortie $sortie): self {
            // set the owning side to null (unless already changed)
            if ($this->sortiesOrganisees->removeElement($sortie) && $sortie->getVilleOrganisatrice() === $this) {
        ...
        public function removeSortie(Sortie $sortie): self {
            // set the owning side to null (unless already changed)
            if ($this->sorties->removeElement($sortie) && $sortie->getVilleAccueil() === $this) {
