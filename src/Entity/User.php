<?php
    ...
    class User implements UserInterface, PasswordAuthenticatedUserInterface {
        ...
        public function getRoles(): array {
            $roles_tmp = $this->roles;
            // guarantee every user at least has ROLE_USER
            $roles_tmp[] = 'ROLE_USER';

            return array_unique($roles_tmp);
        }
        ...
        public function removeSortiesOrga(Sortie $sortiesOrga): self {
            ...
            if ($this->sortiesOrga->removeElement($sortiesOrga) && $sortiesOrga->getOrganisateur() === $this) {
        ...
        public function isMobile(): bool {
            return User::isMobileStatic();
        }

        public static function isMobileStatic() : bool {
