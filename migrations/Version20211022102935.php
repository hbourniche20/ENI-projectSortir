 ...
 */
final class Version20211022102935 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sortie AS SELECT id, ville_organisatrice_id, ville_accueil_id, site_id, organisateur_id, nom, date_sortie, date_limite_inscription, nb_places, duree, description, publiee FROM sortie');
        $this->addSql('DROP TABLE sortie');
        $this->addSql('CREATE TABLE sortie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ville_organisatrice_id INTEGER NOT NULL, ville_accueil_id INTEGER NOT NULL, site_id INTEGER DEFAULT NULL, organisateur_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL, date_sortie DATETIME NOT NULL, date_limite_inscription DATE NOT NULL, nb_places INTEGER NOT NULL, duree INTEGER NOT NULL, description VARCHAR(255) NOT NULL, publiee BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO sortie (id, ville_organisatrice_id, ville_accueil_id, site_id, organisateur_id, nom, date_sortie, date_limite_inscription, nb_places, duree, description, publiee) SELECT id, ville_organisatrice_id, ville_accueil_id, site_id, organisateur_id, nom, date_sortie, date_limite_inscription, nb_places, duree, description, publiee FROM __temp__sortie');
        $this->addSql('DROP TABLE __temp__sortie');
        $this->addSql('CREATE INDEX IDX_3C3FD3F2B8C8DEB3 ON sortie (ville_organisatrice_id)');
        $this->addSql('CREATE INDEX IDX_3C3FD3F2A2C2D9C8 ON sortie (ville_accueil_id)');
