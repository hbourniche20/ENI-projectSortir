 ...
 */
final class Version20211019080942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, pseudo, prenom, nom, tel FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ville_id INTEGER DEFAULT NULL, email VARCHAR(180) NOT NULL COLLATE BINARY, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        ...
        $this->addSql('INSERT INTO user (id, email, roles, password, pseudo, prenom, nom, tel) SELECT id, email, roles, password, pseudo, prenom, nom, tel FROM __temp__user');
