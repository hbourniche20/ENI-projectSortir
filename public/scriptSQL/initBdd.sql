...
INSERT INTO user(id,ville_id, email, pseudo, prenom, nom, tel, roles, password) VALUES (1,1, 'pseu@gmail.com', 'Pseu', 'Valentin','Moi','0698653278','[]','$2y$13$fPxr.WdTTNoVzV9nIPlOquD/tXNcdbJsfVsgKIWYCKXjIkFR.6bm6');
INSERT INTO user(id,ville_id, email, pseudo, prenom, nom, tel, roles, password) VALUES (2,1, 'dop@gmail.com', 'Dop', 'Hugo','Toi','0678451298','[]','$2y$13$fPxr.WdTTNoVzV9nIPlOquD/tXNcdbJsfVsgKIWYCKXjIkFR.6bm6');
INSERT INTO user(id,ville_id, email, pseudo, prenom, nom, tel, roles, password) VALUES (3,2, 'ryu@free.fr', 'Ryu', 'Ryan','Lui','0696857432','[]','$2y$13$fPxr.WdTTNoVzV9nIPlOquD/tXNcdbJsfVsgKIWYCKXjIkFR.6bm6');
INSERT INTO user(id,ville_id, email, pseudo, prenom, nom, tel, roles, password) VALUES (4,2, 'mario@gmail.com', 'Mario', 'Antoine','Eux','0636251498','[]','$2y$13$fPxr.WdTTNoVzV9nIPlOquD/tXNcdbJsfVsgKIWYCKXjIkFR.6bm6');
INSERT INTO user(id,ville_id, email, pseudo, prenom, nom, tel, roles, password) VALUES (5,3, 'peach@gmail.com', 'Peach', 'Océane','Elle','0651545758','[]','$2y$13$fPxr.WdTTNoVzV9nIPlOquD/tXNcdbJsfVsgKIWYCKXjIkFR.6bm6');
INSERT INTO user(id,ville_id, email, pseudo, prenom, nom, tel, roles, password) VALUES (6,4, 'doomguy@gmx.fr', 'DoomGuy', 'Audrey','Autre','0653565952','[]','$2y$13$fPxr.WdTTNoVzV9nIPlOquD/tXNcdbJsfVsgKIWYCKXjIkFR.6bm6');
INSERT INTO user(id,ville_id, email, pseudo, prenom, nom, tel, roles, password) VALUES (7,5, 'rincevent@gmail.com', 'RinceVent', 'Aurore','Nom','0645953512','[]','$2y$13$fPxr.WdTTNoVzV9nIPlOquD/tXNcdbJsfVsgKIWYCKXjIkFR.6bm6');
INSERT INTO user(id,ville_id, email, pseudo, prenom, nom, tel, roles, password) VALUES (8,6, 'sonic@gmail.com', 'Sonic', 'Claire','Jesaispas','0687324516','[]','$2y$13$fPxr.WdTTNoVzV9nIPlOquD/tXNcdbJsfVsgKIWYCKXjIkFR.6bm6');
